...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'quest_eventcontent', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('event', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['quest.Event'], unique=True)),
            ('content', self.gf('django.db.models.fields.TextField')()),
            ('addtime', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal(u'quest', ['EventContent'])

        # Adding model 'Event'
        db.create_table(u'quest_event', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ...
            ('addtime', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('isdelete', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal(u'quest', ['Event'])


    def backwards(self, orm):
        # Deleting model 'EventContent'
        db.delete_table(u'quest_eventcontent')

        # Deleting model 'Event'
        db.delete_table(u'quest_event')
