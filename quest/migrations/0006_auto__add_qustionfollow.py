...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'QustionFollow'
        db.create_table(u'quest_qustionfollow', (
        ...
        db.send_create_signal(u'quest', ['QustionFollow'])
    ...
    def backwards(self, orm):
        # Deleting model 'QustionFollow'
        db.delete_table(u'quest_qustionfollow')
    ...
    models = {
        ...
        u'quest.question': {
            ...
            'content': ('django.db.models.fields.TextField', [], {}),
            'edittime': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'null': 'True', 'blank': 'True'}),
            'follower': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'questions'", 'symmetrical': 'False', 'through': u"orm['quest.QustionFollow']", 'to': u"orm['account.User']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'quest.qustionfollow': {
            'Meta': {'object_name': 'QustionFollow'},
            'addtime': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'question': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['quest.Question']"}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['account.User']"})
